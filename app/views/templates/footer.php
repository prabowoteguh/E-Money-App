               ...
               <!-- DataTables -->
               <!-- <script src="<?= BASE_URL ?>assets/scripts/jquery.dataTables.js"></script> -->
               <!-- <script src="<?= BASE_URL ?>assets/scripts/dataTables.bootstrap4.js"></script> -->
               <!-- <script src="<?= BASE_URL ?>assets/scripts/dataTables.scroller.js"></script> -->
               <!-- <script src="<?= BASE_URL ?>assets/scripts/scroller.bootstrap4.js"></script> -->
               <!-- Sweetallert 2 -->
